...
class _AuthRemoteDataSourceRetrofit implements AuthRemoteDataSourceRetrofit {
  _AuthRemoteDataSourceRetrofit(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'http://admin.copdiary.com/';
  }
  ...
  @override
  Future<HttpResponse<dynamic>> forgotPassword(String mobile) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> verifyOtp(String mobile, String otp) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'mobile': mobile, 'otp': otp};
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(
            method: 'POST',
            headers: _headers,
  ...
  Future<HttpResponse<dynamic>> resetPassword(
    ...
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'mobile': mobile, 'otp': otp, 'new_password': newPassword};
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(
            method: 'POST',
            headers: _headers,
